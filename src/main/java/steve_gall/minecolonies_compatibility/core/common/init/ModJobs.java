...
public class ModJobs
{
	...
	public static final DeferredHolder<JobEntry, JobEntry> GUNNER = REGISTER.register("gunner", builder ->
	{
		builder.setJobProducer(JobGunner::new);
		builder.setJobViewProducer(() -> DefaultJobView::new);
	});
	public static final DeferredHolder<JobEntry, JobEntry> ORCHARDIST = REGISTER.register("orchardist", builder ->
	{
		builder.setJobProducer(JobOrchardist::new);
		builder.setJobViewProducer(() -> DefaultJobView::new);
	});
	public static final DeferredHolder<JobEntry, JobEntry> FLUID_MANAGER = REGISTER.register("fluid_manager", builder ->
	{
		builder.setJobProducer(JobFluidManager::new);
		builder.setJobViewProducer(() -> CrafterJobView::new);
	});
	public static final DeferredHolder<JobEntry, JobEntry> BUTCHER = REGISTER.register("butcher", builder ->
	{
