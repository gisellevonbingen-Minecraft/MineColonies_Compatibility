...
public class GunSmithTableTeachScreen extends TeachCraftingRecipeScreen<GunSmithTableTeachMenu, GunSmithTableRecipe>
{
	...
	@Override
	protected ICustomizedRecipeStorage createRecipeStorage(GunSmithTableRecipe recipe, List<ItemStorage> input)
	{
