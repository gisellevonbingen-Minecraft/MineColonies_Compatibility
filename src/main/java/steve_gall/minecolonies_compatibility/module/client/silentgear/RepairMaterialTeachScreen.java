...
public class RepairMaterialTeachScreen extends TeachRecipeScreen<RepairMaterialTeachMenu, ItemStack>
{
	...
	protected void renderBg(PoseStack graphics, float partialTicks, int mouseX, int mouseY)
	{
		...
		if (this.lastRecipe != null)
		{
			...
			this.font.drawShadow(graphics, this.materialText, x, y, 0xFFFFFFFF);
			y += this.font.lineHeight;
			this.font.drawShadow(graphics, this.tierText, x, y, 0xFFFFFFFF);
			y += this.font.lineHeight;
			this.font.drawShadow(graphics, this.valueText, x, y, 0xFFFFFFFF);
			y += this.font.lineHeight;
		}
