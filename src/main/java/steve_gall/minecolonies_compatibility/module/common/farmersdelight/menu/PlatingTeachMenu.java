...
public class PlatingTeachMenu extends TeachRecipeMenu<PlatingRecipeStorage, SingleRecipeInput>
{
	...
	@Override
	protected IMenuRecipeValidator<PlatingRecipeStorage, SingleRecipeInput> createRecipeValidator()
	{
		return new IMenuRecipeValidator<>()
		{
			@Override
			public SingleRecipeInput getInput(Container container, PlatingRecipeStorage recipe)
			{
			...
			@Override
			public PlatingRecipeStorage deserialize(HolderLookup.Provider provider, IFactoryController controller, CompoundTag tag)
			{
				return PlatingRecipeStorage.deserialize(provider, controller, tag);
			}

			public CompoundTag serialize(HolderLookup.Provider provider, IFactoryController controller, PlatingRecipeStorage recipe)
			{
				var tag = new CompoundTag();
				PlatingRecipeStorage.serialize(provider, controller, tag, recipe);
				return tag;
			}
		};
	}
	...
	@Override
	protected void setContainerByTransfer(HolderLookup.Provider provider, PlatingRecipeStorage recipe, CompoundTag payload)
	{
