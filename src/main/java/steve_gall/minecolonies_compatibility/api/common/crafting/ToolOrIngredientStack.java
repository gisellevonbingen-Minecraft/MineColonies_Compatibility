...
public class ToolOrIngredientStack
{
	...
	public @NotNull EquipmentTypeEntry toolType()
	{
	...
	public static @NotNull ToolOrIngredientStack of(@NotNull EquipmentTypeEntry toolType)
	{
	...
	{
		return new ToolOrIngredientStack(false, ModEquipmentTypes.none.get(), IngredientStack.of(ingredient));
	}

	public static @NotNull ToolOrIngredientStack of(@NotNull Ingredient ingredient, int count)
	{
		return new ToolOrIngredientStack(false, ModEquipmentTypes.none.get(), IngredientStack.of(ingredient, count));
	}
