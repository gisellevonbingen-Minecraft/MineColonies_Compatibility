...
public class GrinderGenericRecipe extends SimpleGenericRecipe
{
	...
	public GrinderGenericRecipe(GrinderRecipe recipe)
	{
		this(recipe.getId(), Collections.singletonList(ingredients(recipe.ingredient, recipe.count)), recipe.getResultItem(), recipe.attachment);
	}
