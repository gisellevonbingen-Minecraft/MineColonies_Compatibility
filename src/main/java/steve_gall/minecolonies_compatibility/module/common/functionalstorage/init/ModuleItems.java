...
public class ModuleItems
{
	...
	public static final RegistryObject<BlockItem> CITIZEN_EXTENSION = REGISTER.register("citizen_extension", () -> new BlockItem(ModuleBlocks.CITIZEN_EXTENSION.get(), new Item.Properties()));
