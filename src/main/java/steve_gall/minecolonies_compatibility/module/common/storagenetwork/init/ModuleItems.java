...
public class ModuleItems
{
	...
	public static final RegistryObject<BlockItem> CITIZEN_INVENTORY = REGISTER.register("citizen_inventory", () -> new BlockItem(ModuleBlocks.CITIZEN_INVENTORY.get(), new Item.Properties().tab(ModCreativeTabs.MINECOLONIES)));
