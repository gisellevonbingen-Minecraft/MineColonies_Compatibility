...
public class ModuleItems
{
	...
	public static final RegistryObject<BlockItem> CITIZEN_SLAVE = REGISTER.register("citizen_slave", () -> new BlockItem(ModuleBlocks.CITIZEN_SLAVE.get(), new Item.Properties().tab(ModCreativeTabs.MINECOLONIES)));
