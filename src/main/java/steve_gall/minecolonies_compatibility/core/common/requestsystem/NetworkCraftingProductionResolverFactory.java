...
public class NetworkCraftingProductionResolverFactory implements IRequestResolverFactory<NetworkCraftingProductionResolver>
{
	...
	@Override
	public CompoundTag serialize(IFactoryController controller, NetworkCraftingProductionResolver input)
	{
	...
	@Override
	public NetworkCraftingProductionResolver deserialize(IFactoryController controller, CompoundTag tag)
	{
	...
	@Override
	public void serialize(IFactoryController controller, NetworkCraftingProductionResolver input, FriendlyByteBuf buffer)
	{
	...
	@Override
	public NetworkCraftingProductionResolver deserialize(IFactoryController controller, FriendlyByteBuf buffer) throws Throwable
	{
