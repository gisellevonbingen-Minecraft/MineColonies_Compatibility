...
public class GunBenchTeachScreen extends TeachCraftingRecipeScreen<GunBenchTeachMenu, GunBenchRecipe>
{
	...
	@Override
	protected ICustomizedRecipeStorage createRecipeStorage(GunBenchRecipe recipe, List<ItemStorage> input)
	{
		...
		return new GunBenchRecipeStorage(recipe.getId(), ingredients, blueprint, output);
	}
