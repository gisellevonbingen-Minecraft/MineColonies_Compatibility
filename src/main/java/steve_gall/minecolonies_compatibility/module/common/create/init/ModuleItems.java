...
public class ModuleItems
{
	...
	public static final RegistryObject<BlockItem> CITIZEN_STOCK_KEEPER = REGISTER.register("citizen_stock_keeper", () -> new BlockItem(ModuleBlocks.CITIZEN_STOCK_KEEPER.get(), new Item.Properties()));
