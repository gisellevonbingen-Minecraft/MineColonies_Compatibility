...
public class SilentGearToolSystem extends CustomizedToolSystem
{
	...
	{
		return stack.getItem() instanceof GearWeapon;
	}
	...
	{
		return TierHelper.getGearTier(stack);
	}

	@Override
	public float getAttackDamage(@NotNull ItemStack stack)
	{
		return GearData.getProperties(stack).getNumber(GearProperties.ATTACK_DAMAGE);
	}
