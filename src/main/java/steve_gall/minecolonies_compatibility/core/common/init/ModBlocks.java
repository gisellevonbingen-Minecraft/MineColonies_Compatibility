...
public class ModBlocks
{
	...
	public static final RegistryObject<CommonNetworkStorageBlock> COMMON_NETWORK_STORAGE = REGISTER.register("common_network_storage", () -> new CommonNetworkStorageBlock(BlockBehaviour.Properties.of().mapColor(MapColor.WOOD).strength(1.0F)));
