...
public class ModuleCraftingTypes
{
	...
	public static final DeferredHolder<CraftingType, PlatingCraftingType> PLATING = DeferredRegisterHelper.registerCraftingType(REGISTER, "farmers_plating", PlatingCraftingType::new);
