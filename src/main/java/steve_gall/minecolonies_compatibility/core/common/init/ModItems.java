...
public class ModItems
{
	...
	public static final RegistryObject<BlockItem> COMMON_NETWORK_STORAGE = REGISTER.register("common_network_storage", () -> new BlockItem(ModBlocks.COMMON_NETWORK_STORAGE.get(), new Item.Properties().tab(ModCreativeTabs.MINECOLONIES)));
