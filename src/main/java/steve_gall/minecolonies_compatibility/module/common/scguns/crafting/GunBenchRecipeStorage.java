...
public class GunBenchRecipeStorage extends SimpleRecipeStorage<GunBenchGenericRecipe>
{
	...
	public GunBenchRecipeStorage(IFactoryController controller, CompoundTag tag)
	{
		super(controller, tag);

		this.blueprint = controller.deserialize(tag.getCompound("blueprint"));
	}
	...
	public void serialize(IFactoryController controller, CompoundTag tag)
	{
		...
		tag.put("blueprint", controller.serialize(this.blueprint));
	}
