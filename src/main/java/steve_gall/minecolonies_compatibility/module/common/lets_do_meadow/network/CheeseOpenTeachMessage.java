...
{
	public static final CustomPacketPayload.Type<CheeseOpenTeachMessage> TYPE = new CustomPacketPayload.Type<>(MineColoniesCompatibility.rl("let_do_meadow_cheese_open_teach"));
	...
	public CheeseOpenTeachMessage(RegistryFriendlyByteBuf buffer)
	{
		super(buffer);
	}
	...
	@Override
	public CustomPacketPayload.Type<CheeseOpenTeachMessage> type()
	{
		return TYPE;
	}
