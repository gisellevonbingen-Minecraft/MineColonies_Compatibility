...
public class WoodcuttingTeachScreen extends TeachCraftingRecipeScreen<WoodcuttingTeachMenu, RecipeHolder<WoodcuttingRecipe>>
{
	...
	@Override
	protected ICustomizedRecipeStorage createRecipeStorage(RecipeHolder<WoodcuttingRecipe> recipe, List<ItemStorage> input)
	{
		var resultContainer = this.menu.getResultContainer();
		var output = resultContainer.getItem(0);
		return new WoodcuttingRecipeStorage(recipe.id(), input, output);
	}
