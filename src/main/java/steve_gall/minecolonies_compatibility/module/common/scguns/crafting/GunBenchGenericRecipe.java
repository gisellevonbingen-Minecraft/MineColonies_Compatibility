...
public class GunBenchGenericRecipe extends SimpleGenericRecipe
{
	...
	public GunBenchGenericRecipe(GunBenchRecipe recipe, RegistryAccess registryAccess)
	{
		this(recipe.getId(), IngredientHelper.getStacksList(IngredientHelper.filterNotEmpty(recipe.getIngredients())), IngredientHelper.getStacks(recipe.getBlueprint()), recipe.getResultItem(registryAccess));
	}
