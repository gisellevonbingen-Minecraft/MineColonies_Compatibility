...
public class ResearchCategory implements IRecipeCategory<ResearchCache>
{
	...
	@Override
	public void draw(ResearchCache cache, IRecipeSlotsView recipeSlotsView, PoseStack poseStack, double mouseX, double mouseY)
	{
		var mc = Minecraft.getInstance();
		var font = mc.font;
		font.draw(poseStack, cache.header, 0.0F, 0.0F, 0xFF000000);
		font.draw(poseStack, cache.name, 0.0F, 10.0F, 0xFF000000);
	}
